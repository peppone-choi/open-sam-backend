...
export class ReleasePrisonerCommand extends GeneralCommand {
  protected static actionName = '포로 해방';
  ...
  public getBrief(): string {
    ...
    const name = ReleasePrisonerCommand.getName();
  ...
  public async run(rng: any): Promise<boolean> {
    ...
    this.setResultTurn(new LastTurn(ReleasePrisonerCommand.getName(), this.arg));
