...
/**
 * SetNationAttr Service
 * 국가 속성 설정
 */
export class SetNationAttrService {
  static async execute(data: any, user?: any) {
    ...
    try {
      ...
      if (officerLevel !== 12) {
        return { success: false, message: '권한이 부족합니다. 군주만 설정할 수 있습니다' };
      }
      ...
      const allowedAttrs = ['name', 'color', 'type', 'capital'];
